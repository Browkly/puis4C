...
int alignment(player *p, grid *g)
{
    ...
    for (i = 0; i < 4; i++)
    {
        ...
        {
            if (((g->g)[p->last_y][i + 1] == p->number_player) && ((g->g)[p->last_y][i + 2] == p->number_player) && ((g->g)[p->last_y][i + 3] == p->number_player))
            {
                return 1;
            }
        }
    ...
    for (j = 0; j < 3; j++)
    {
        ...
        {
            if ((g->g)[j + 1][p->last_x] == p->number_player && (g->g)[j + 2][p->last_x] == p->number_player && (g->g)[j + 3][p->last_x] == p->number_player)
            {
                return 1;
            }
        }
    ...
    while (min_i + 3 < 7 && min_j - 3 > 0)
    {
        ...
        {
            if ((g->g)[min_j - 1][min_i + 1] == p->number_player && (g->g)[min_j - 2][min_i + 2] == p->number_player && (g->g)[min_j - 3][min_i + 3] == p->number_player)
            {
                return 1;
            }
        }
